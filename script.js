...
document.querySelector('#btnTobegin').addEventListener('click', function () {   // Клик по кнопке НАЧАТЬ ИГРУ --> Переход на карточку Диапазон значений
...
document.querySelector('#btnProceed').addEventListener('click', function () {   // Клик по кнопке ПРОДОЛЖИТЬ --> Переход на карточку Условия с кнопкой ИГРАТЬ
...
document.querySelector('#btnPlay').addEventListener('click', function () {      // Клик по кнопке ИГРАТЬ --> Переход на карточку Вопрос №, с кнопками: меньше, больше, верно, заново
    ...
    document.querySelector('#btnLess').addEventListener('click', function () { // Код для кнопки «Меньше».
        if (gameRun) {
    ...
    document.querySelector('#btnOver').addEventListener('click', function () { // Код для кнопки «Больше».
        if (gameRun) {
    ...
    document.querySelector('#btnEqual').addEventListener('click', function () { // Код для кнопки "Верно".
        if (gameRun) {
            const phraseRandom = Math.round(Math.random() * 3);
            switch (phraseRandom) {
                case 0:
...
// Диапазон значений Введите минимальное и максимальное значение числа для игры (от -999 до 999), кнопка ПРОДОЛЖИТЬ
document.querySelector('#btnRetry').addEventListener('click', function () {     // Клик по кнопке Заново --> Переход на карточку Диапазон значений
